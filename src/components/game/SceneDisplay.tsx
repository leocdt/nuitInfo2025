                    ...
                    <div className="absolute bottom-0 left-0 w-full z-40">
                        ...
                        {currentDialogue && !isQuestion && !currentDialogue.input && currentDialogue.speaker !== 'Chatrlatant' && (
                            <DialogueBox
                                ...
                                avatarSrc={
                                    currentDialogue.speaker === 'Chatrlatant' ? '/images/personnages/chat/cat_basic.png' :
                                        currentDialogue.speaker === 'Narateur' ? '/images/background/narat.webp' :
                                            (currentDialogue.speaker === 'Vous' || currentDialogue.speaker === 'Nous') ? '/images/background/nous.webp' :
                                                '/images/background/profilepic.png'
                                }
